...
function AyatQuranSection() {
  return (
    <div id="fh5co-ayat">
    <img height="400" width="100%" style={{position: "absolute", bottom: "-175px"}} src="/img/background/wave-down.svg"/>
    <div className="container">
        <div className="ayat-content animate-box font-dancing-script">
...
export default AyatQuranSection